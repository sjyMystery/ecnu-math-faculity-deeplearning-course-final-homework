...
IMAGE_SIZE = ci.IMAGE_SIZE
NUM_CLASSES = ci.NUM_CLASSES
NUM_EXAMPLES_PER_EPOCH_FOR_TRAIN = ci.NUM_EXAMPLES_PER_EPOCH_FOR_TRAIN
NUM_EXAMPLES_PER_EPOCH_FOR_EVAL = ci.NUM_EXAMPLES_PER_EPOCH_FOR_EVAL
...
def _variable_with_weight_decay(name, shape, stddev, wd):
  ...
  if wd:
    weight_decay = tf.math.multiply(tf.nn.l2_loss(var), wd, name='weight_loss')
...
def distorted_inputs(data_dir):
  ...
  """
  return ci.distorted_inputs(data_dir,
...
def inputs(data_dir):
  ...
  Raises:
    ValueError: If no data_dir
  """
  return ci.inputs(data_dir,batch_size=FLAGS.batch_size)
